...
<form id = "fm" align = "center">
    ...
    <c:if test="${USER.type == '1'}">
        ...
        性别:<input type = "checkbox" name = "sex" value="1"/>男
            <input type = "checkbox" name = "sex" value="2"/>女<br/><br/>
        <c:if test="${types == '4'}">
        身份:
            <input type="checkbox" name="type" value="2">医生
            <input type="checkbox" name="type" value="3">患者
        </c:if>
